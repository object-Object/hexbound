    ...
    val CONFIG = buildConfig(Hexbound.id("config")) {
        section("client") {
            value("force_alternate_construct") {
                ...
                bind(HexboundConfig::replaceSpiderConstruct)
            ...
            value("broadcaster_particle_amount") {
                ...
                bind(HexboundConfig::broadcasterParticleAmount)
        ...
        section("misc") {
            value("spider_battery_charge") {
                ...
                bind(HexboundConfig::spiderBatteryChargeRequired)
            ...
            value("construct_pathfinding_attempts") {
                ...
                bind(HexboundConfig::constructPathfindingAttempts)
        ...
        section("execution") {
            listValue("construct_action_deny_list") {
                ...
                bind(HexboundConfig::constructActionDenyList)
